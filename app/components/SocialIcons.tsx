...
/* Social glyphs + a shared circular icon-link, used in both the desktop nav
   and the mobile curtain so the treatment stays identical. */
...
export function PhoneGlyph({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden>
      <path d="M6.62 10.79a15.53 15.53 0 0 0 6.59 6.59l2.2-2.2a1 1 0 0 1 1.02-.24c1.12.37 2.33.57 3.57.57a1 1 0 0 1 1 1V20a1 1 0 0 1-1 1A17 17 0 0 1 3 4a1 1 0 0 1 1-1h3.49a1 1 0 0 1 1 1c0 1.25.2 2.45.57 3.57a1 1 0 0 1-.25 1.02l-2.19 2.2z" />
    </svg>
  )
}
...
export function SocialIconLink({ href, label, children }: SocialIconLinkProps) {
  // Alleen echte URL's openen in een nieuw tabblad; een placeholder (#) niet.
  ...
  return (
    <a
      ...
      className="flex h-9 w-9 items-center justify-center rounded-full border border-white/25 text-white/85 transition-colors duration-200 hover:border-bronze hover:bg-bronze hover:text-white"
    >
      {children}
    </a>
  )
