...
export default function WhatsAppButton() {
  return (
    <a
      href="https://wa.me/31620779977"
      target="_blank"
      rel="noopener noreferrer"
      aria-label="Contacteer ons via WhatsApp"
      className="fixed bottom-6 right-6 z-50 flex h-14 items-center gap-2.5 rounded-full bg-[#25D366] pl-4 pr-5 shadow-lg transition-transform duration-200 hover:scale-105 hover:shadow-xl"
    >
      <svg
