    ...
    <main className="bg-cream text-ink">
      ...
      <section className="relative flex min-h-[78vh] w-full items-end overflow-hidden md:items-center">
        ...
        <div className="relative z-10 mx-auto w-full max-w-container px-6 pb-14 md:pb-0">
          <div className="max-w-2xl">
            ...
            <a
              href="/#contact"
              className="animate-fade-up mt-8 inline-flex rounded-full bg-bronze px-7 py-3.5 text-base font-semibold text-white shadow-lg transition-colors hover:bg-bronze-dark"
      ...
      <section className="bg-ink py-24">
        <div className="mx-auto max-w-container px-6 text-center">
          ...
          <a
            href="/#contact"
            className="animate-on-scroll mt-8 inline-flex rounded-full bg-bronze px-8 py-4 text-base font-semibold text-white transition-colors hover:bg-bronze-dark"
            data-delay="0.28s"
          >
